...
public class TestInvalidUsername extends BaseTest {

    /**
     * Assert we get error when user tries to log in with wrong username
    ...
    public void testLoginError(String username, String password, String errorText) {
        ...
        loginPage.login(username + "xx", password);
